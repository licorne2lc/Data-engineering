...
db.py
=====
Helpers de connexion Postgres pour le pipeline Enedis.
...
def get_conn() -> Iterator[psycopg2.extensions.connection]:
    """Connexion Postgres en context manager, commit auto si pas d'erreur."""
...
def execute_sql_file(path: str | Path) -> None:
    """Exécute un fichier SQL entier (DDL idempotent)."""
